...
impl ColorPrimary {
    fn from_index(index: u8) -> Option<&'static str> {
        match index {
            0 => Some("Reserved"),
            1 => Some("ITU-R BT.709"),
            2 => Some("Unspecified"),
            3 => Some("Reserved"),
            4 => Some("ITU-R BT.470M"),
            5 => Some("ITU-R BT.470BG"),
            6 => Some("SMPTE 170M"),
            7 => Some("SMPTE 240M"),
            8 => Some("FILM"),
            9 => Some("ITU-R BT.2020"),
            10 => Some("SMPTE ST 428-1"),
            11 => Some("DCI P3"),
            12 => Some("P3 D65"),
            _ => None,
        }
...
impl TransferFunction {
    fn from_index(index: u8) -> Option<&'static str> {
        match index {
            ...
            2 => Some("Unspecified"),
            3 => Some("Reserved"),
            4 => Some("Gamma 2.2 curve"),
            5 => Some("Gamma 2.8 curve"),
            6 => Some("SMPTE 170M"),
            7 => Some("SMPTE 240M"),
            8 => Some("Linear"),
            9 => Some("Log"),
            ...
            12 => Some("ITU-R BT.1361 Extended Colour Gamut"),
            13 => Some("IEC 61966-2-1"),
            14 => Some("ITU-R BT.2020 10 bit"),
            15 => Some("ITU-R BT.2020 12 bit"),
...
impl Matrix {
    fn from_index(index: u8) -> Option<&'static str> {
        match index {
            ...
            7 => Some("SMPTE 240M"),
            8 => Some("YCOCG"),
            9 => Some("BT2020 Non-constant Luminance"),
            10 => Some("BT2020 Constant Luminance"),
            11 => Some("SMPTE ST 2085 (2015)"),
            12 => Some("Chromaticity-derived non-constant luminance system"),
            13 => Some("Chromaticity-derived constant luminance system"),
            14 => Some("Rec. ITU-R BT.2100-0 ICTCP"),
            _ => None,
        }
    }
}
...
fn transfer_characteristics_value_check(s: &str) -> Result<u8, String> {
    value_check(
        ...
        "transfer function",
        TransferFunction::from_index,
    )
}

fn matrix_coefficients_value_check(s: &str) -> Result<u8, String> {
    value_check(s, MATRIX_RANGE, "matrix", Matrix::from_index)
}
